function CommunityFilter({
  ...
  return (
    <>
      <div className="flex flex-col gap-4 px-3 py-4 md:flex-row md:items-center md:px-6 lg:px-10">
        ...
        <div className="flex w-full max-w-full gap-2 overflow-x-auto whitespace-nowrap pb-1">
